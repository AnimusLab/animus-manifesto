  ...
  return (
    <main>
      <header className="border-b border-gray-800 pb-4 mb-10">
        ...
        <p className="text-sm text-gray-600 mt-2">SYSTEM.WITNESS // PORT: 443</p>
      ...
      <article className="space-y-8">
        ...
        <section className="space-y-4 text-gray-300 pb-8">
          <h3 className="text-xl text-white mt-8 mb-4">III. The Inevitability</h3>
          <p>
